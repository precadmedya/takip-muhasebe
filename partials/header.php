            ...
            <ul class="navbar-nav ms-auto">
                <?php if(isset($_SESSION['user_id'])): ?>
                    <?php if(isYonetici()): ?>
                        ...
                        <li class="nav-item"><a class="nav-link" href="/admin/firms.php">Firmalar</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link" href="/admin/firms.php">Abonelikler</a></li>
                        <li class="nav-item"><a class="nav-link" href="/firma/email_settings.php">E-posta Ayarları</a></li>
                    ...
                    <?php else: ?>
                        ...
                        <li class="nav-item"><a class="nav-link" href="/firma/subscription.php">Abonelik</a></li>
                        <li class="nav-item"><a class="nav-link" href="/firma/email_settings.php">E-posta Ayarları</a></li>
                        <li class="nav-item"><a class="nav-link" href="/logout.php">Çıkış</a></li>
                    <?php endif; ?>
                <?php else: ?>
